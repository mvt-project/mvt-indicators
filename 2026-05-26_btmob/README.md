...
In contrast to some other MaaS, which often focus only on banking data, it can be used as comparatively low-cost spyware. 
Based on data from any.run BTMOB is still actively deployed. 
